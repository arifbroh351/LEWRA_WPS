#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# LEWRA_WPS (C) 2018, MODDED BY ARIF-BROH
# VERSION 1.0.1
    ...
    def iw_scanner(self) -> Dict[int, dict]:
        ...
        if self.vuln_list:
            print('{1} {0} {2} {0} {3}'.format(
                '|',
                colored('WPS UNLOCKED', color='green'),
                colored('WPS LOCKED', color='red'),
                colored('AGEI GUWA MARCHO', color='yellow')
            ))
...
\n\t\t[\033[1;32m*\033[1;37m] DEVELOPER :   ARIF-BROH
\n\t\t[\033[1;32m*\033[1;37m] FACEBOOK  : ARIFBROH351
\n\t\t[\033[1;32m*\033[1;37m] WHATSAPP : +8801612600351
\n\t\t[\033[1;32m*\033[1;37m] NOTE : WORK ONLY WPS ENABLED WIFI''')
        ...
        while 1:
            try:
                print('\n\033[1;32m════════════════════════════════════════════════════════\033[1;37m')
                networkNo = input('[\033[1;33m?\033[1;37m] Broh Select target (press Enter to refresh): ')
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='LEWRA_WPS (C) 2018, MODDED BY ARIF-BROH',
        ...
        try:
            ...
            if args.loop:
                if input("\n[?] Exit the script (otherwise continue to AP scan)? [N/y] ").lower() == 'y':
                    ani("\n[\033[1;31m!\033[1;37m] MANGER NATI KOI JAS...?🥴")
                    break
                else:
                    args.bssid = None
            else:
