...
__   ___________________________________________________   __
  | |                                                   | |  
\033[1;36m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
 \033[1;37mOwner   :            ARIF-BROH
 \033[1;37mFacebook:            arifbroh351
 \033[1;37mGithub  :            arifbroh351
 \033[1;37mWhatsapp:            +8801612600351
 \033[1;31mHelp    :            FB-AND-TELEGRAM
\033[1;36m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
""")
...
class WiFiScanner:
    ...
    def iw_scanner(self) -> Dict[int, dict]:
        ...
        if self.vuln_list:
            print('{1} {0} {2} {0} {3}'.format(
                '|',
                colored('WPS ENABLED', color='green'),
                colored('WPS LOCKED', color='red'),
                colored('AGEI GUWA MARA HOYECHE', color='yellow')
            ))
    ...
    def prompt_network(self) -> str:
        ...
        while 1:
            try:
                networkNo = input('Broh Select target (press Enter to refresh): ')
